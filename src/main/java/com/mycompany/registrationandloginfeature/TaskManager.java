...
public class TaskManager{
    ...
    private void deleteTask(List<Map<String, String>> tasks) {
        String taskID = JOptionPane.showInputDialog("Enter the Task ID of the task you want to delete:");
    ...
    private void searchTask(List<Map<String, String>> tasks) {
        String taskID = JOptionPane.showInputDialog("Enter the Task ID of the task you want to search:");
        boolean taskFound = false;
        for (Map<String, String> task : tasks) {
            if (task.get("Task ID").equals(taskID)) {
                taskFound = true;
